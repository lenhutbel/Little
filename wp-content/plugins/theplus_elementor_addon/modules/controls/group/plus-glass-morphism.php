	...
	public function tp_glass_morphism_controls($element) {		
		...
		$element->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} > .elementor-container,{{WRAPPER}} > .elementor-column-wrap,{{WRAPPER}} > .elementor-widget-wrap,{{WRAPPER}} > .elementor-widget-container,{{WRAPPER}}.e-container > div' => '-webkit-backdrop-filter:grayscale({{scwbf_grayscale.SIZE}})  blur({{scwbf_blur.SIZE}}{{scwbf_blur.UNIT}}) !important;backdrop-filter:grayscale({{scwbf_grayscale.SIZE}})  blur({{scwbf_blur.SIZE}}{{scwbf_blur.UNIT}}) !important;',
				 ],
				 'condition' => [
					'scwbf_options' => 'yes',
				],
