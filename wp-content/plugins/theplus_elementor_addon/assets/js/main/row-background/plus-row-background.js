( function( $ ) {	
	var WidgetRowBackgroundHandler = function ($scope, $) {
		...
		var parent_row= row_bg_elem.closest('section.elementor-element,.elementor-element.e-container.e-container--row');
		var wid_sec=$scope.closest('section.elementor-element,.elementor-element.e-container.e-container--row');
