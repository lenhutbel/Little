	...
	var WidgetHeaderNavigation = function($scope, $) {
		...
		if($plus_navigation.length > 0){
			...
			if (nav_sticky!=undefined && nav_sticky=='yes' && nav_sticky_id!='') {
				var sec_id = $plus_navigation.closest(".elementor-element.elementor-section:not(.elementor-inner-section),.elementor-element.e-container").addClass("plus-nav-sticky-sec").data("id");
				if(inner_width > 801 && $plus_navigation.closest(".elementor-element.elementor-section:not(.elementor-inner-section):not(.elementor-hidden-desktop),.elementor-element.e-container").length){				
					$plus_navigation.append('<div class="plus-nav-sticky ' + nav_sticky_id + "-" + sec_id + '"></div>');
				}
				if(inner_width < 800 && inner_width > 768 && $plus_navigation.closest(".elementor-element.elementor-section:not(.elementor-inner-section):not(.elementor-hidden-tablet),.elementor-element.e-container").length){
					$plus_navigation.append('<div class="plus-nav-sticky ' + nav_sticky_id + "-" + sec_id + '"></div>');
				}
				
				if(inner_width < 767 && $plus_navigation.closest(".elementor-element.elementor-section:not(.elementor-inner-section):not(.elementor-hidden-phone),.elementor-element.e-container").length){
					$plus_navigation.append('<div class="plus-nav-sticky ' + nav_sticky_id + "-" + sec_id + '"></div>');
				}				
